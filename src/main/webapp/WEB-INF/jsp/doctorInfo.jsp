<%@ page import="com.hospital_ssm.pojo.WorkDay" %>
<%@ page import="java.util.List" %>
<%@ page import="com.hospital_ssm.util.Util" %>
                ...
                <div class="title2">
                    <%
                        ...
                        for (int i = 0; i < 7; i++) {
                            ...
                            sb.append(Util.getWeek(workDays.get(i * 2).getWorktime()));
                            sb.append("<br>");
                            sb.append(Util.getDate(workDays.get(i * 2).getWorktime()));
                            sb.append("</li>");
                            for (int j = 0; j < 2; j++) {
                                sb.append("<li class='");
                                sb.append(workDays.get(i * 2 + j).getState());
                                if ("预约".equals(workDays.get(i * 2 + j).getState()) && !"今天".equals(Util.getWeek(workDays.get(i * 2).getWorktime()))) {
