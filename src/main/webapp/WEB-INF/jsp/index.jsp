...
<div style="margin-top: 65px;margin-left: 300px">
    <div id="page-inner">
        <div class="container">
            <div id="myCarousel" class="carousel slide" align="center">
                ...
                <div class="carousel-inner" style="width: 950px;height: 300px; ">
                    <div class="item active">
                        <img src="images/index3.jpeg" alt="First slide"><br><br>
                    </div>
                    <div class="item">
                        <img src="images/index1.jpg" alt="Second slide"><br><br>
                    </div>
                    <div class="item">
                        <img src="images/index2.jpg" alt="Third slide"><br><br>
                    </div>
                </div>
                <!-- 轮播（Carousel）导航 -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4" style="height: 530px;margin-top: 57px; background:url(images/index.png)">
                        <h3>健康科普</h3>
                        <p> 干货！这么吃，或许可以降血压？ </p>
                        <p> 2022-01-04 16:05:16 </p>
                    </div>
                    <div class="col-md-8" style=" border:  0px solid red; margin-top: 55px;">
                        <h3>特色医疗服务</h3>
                        <img src="images/index4.jpg" style="width: 60%;height: 400px"/>
                        <div style="width: 60% ;height: 70px ;border: 0px solid grey;">
                            <h4>“天玑”！擅长骨科精准微创手术，手术精度 ≤ 1mm</h4>
                            <p> 12月22日，珠海市人民医院创伤骨科主任蒋煜文带领骨科团队使用“天玑”骨科手术机器人成功为一名老年股骨颈骨折患者完成骨折内固定手术 </p>
                        </div>
            ...
            <div style="width: 100%;height: 120px ;align-content: center;border: 1px solid red ;background: url(images/bottom.png)">
                <div align="center " style="width: ">


                    <h1><font color="white">珠海市人民医院————人民自己的医院</font></h1>
                    <p><font color="white">地址：珠海市康宁路79号
                        咨询/预约电话：0756-2222569
                        ©珠海市人民医院 版权所有 粤ICP备19149467号
                        2021 All Rights Reserved Copyright (C), 珠海市人民医院
                        公安备案号: 44040202000592，技术支持:珠海市大悦科技有限公司</font></p>
                </div>
            </div>
        </div>
    </div>
